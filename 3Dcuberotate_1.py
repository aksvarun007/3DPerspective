...
try:
	...
	face_cascade=cv2.CascadeClassifier('/home/akshay/Documents/OpenCV/opencv-2.4.9/data/haarcascades/haarcascade_frontalface_alt_tree.xml')
...
def haar():
	...
	face_x=int(alpha*face_x+(1-alpha)*old_x)
	face_y=int(alpha*face_y+(1-alpha)*old_y)
	face_w=int(alpha*face_w+(1-alpha)*old_w)
	face_h=int(alpha*face_h+(1-alpha)*old_h)
